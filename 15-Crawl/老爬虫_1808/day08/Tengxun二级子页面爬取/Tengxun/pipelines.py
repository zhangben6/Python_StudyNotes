...
class TengxunPipeline(object):
    def process_item(self, item, spider):
        print("===================")
        print("岗位名称",item['zhName'])
        print("岗位类型",item['zhType'])
        print("岗位人数",item['zhNum'])
        print("岗位地址",item['zhAddress'])
        print("岗位时间",item['zhTime'])
        print("岗位链接",item['zhLink'])
        print("岗位职责",item['zhZhize'])
        print("岗位要求",item['zhYaoqiu'])
        print("===================")
        return item
